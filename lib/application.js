...
waitInstallComplete = function(slug, timeout, callback) {
  var Realtimer, appNotListedErrMsg, appNotStartedErrMsg, noAppListErrMsg, realtime, timeoutId;
  ...
  return realtime.on('application.update', function(event, id) {
    var token;
...
module.exports.installController = function(app, callback) {
  ...
  return client.stop(app.slug, function(err, res, body) {
    ...
    return dsClient.post('request/access/byApp/', {
      ...
      var ref, ref1;
      if ((body != null ? (ref = body[0]) != null ? (ref1 = ref.value) != null ? ref1.token : void 0 : void 0 : void 0) != null) {
